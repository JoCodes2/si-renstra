    ...
    <div class="row">
        <div class="col-md-12">
            <div class="m-1 p-1">
                ...
                <br>
                <table class="table table-bordered table-striped" style="background-color: #dbdbdb;">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th scope="col" style="background-color: rgb(255, 208, 182);">Memanfaatkan kekuatan internal
                                perusahaan
                                untuk mengambil peluang eksternal.</th>
                            <th scope="col" style="background-color: rgb(168, 246, 203);">Menggunakan peluang eksternal
                                untuk
                                mengatasi kelemahan internal.</th>
                        </tr>
                        <tr class="bg-light">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="background-color: rgb(255, 208, 182);">Memanfaatkan kekuatan internal
                                perusahaan
                                untuk mengurangi dampak atau menghindari ancaman eksternal.</th>
                            <th scope="col" style="background-color: rgb(168, 246, 203);">Mengembangkan strategi defensif
                                untuk
                                meminimalkan kelemahan internal dan menghindari ancaman eksternal.</th>
                        </tr>
                    </thead>
                </table>
